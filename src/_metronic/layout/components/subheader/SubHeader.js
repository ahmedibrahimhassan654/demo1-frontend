...
<>
<div>
  <span>{date}</span>{separator}/
  <span>{month}</span>{separator}/
  <span>{year}</span>{separator}
</div>
        ...
        >
          ...
          <div className="d-flex align-items-center">
            <a href="#" className="btn btn-light btn-sm font-weight-bold" id="kt_dashboard_daterangepicker"
              ...
              <span className="text-primary font-weight-bold" id="kt_dashboard_daterangepicker_date">{getCurrentDate()}</span>
            </a>
            <QuickActions/>
          </div>
        </div>
