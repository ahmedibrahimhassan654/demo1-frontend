...
// import background from '../../../../components/images/logo2.jpeg'
            ...
            >
              ...
              <div className="d-flex flex-row-fluid flex-column justify-content-between">
                ...
                <div className="flex-column-fluid d-flex flex-column justify-content-center">
                  <h3 className="font-size-h1 font-weight-lighter mb-5 text-black">
                    Welcome to Online Doctor!
                  </h3>
                  <p className="font-weight-lighter font-size-h4 text-black opacity-80">
